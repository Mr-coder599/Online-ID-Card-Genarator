...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`name`, `id_no`, `email`, `phone`,`semester`, `address`, `dob`, `exp_date`, `image`) VALUES ('$name','$id_no','$email]','$phone','$semester','$address','$dob','$exp_date','$uploadfile')"; 
...
<link rel="icon" type="image/png" href="images/favicon.png"/>
  <title>Add New Student | FPE</title>
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc">Matric Number:</label>
...
*/ -->
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <a href="logout.php" style="color:green; margin-left:20px; border: 1px solid green; padding:5px; border-radiu:5px; text-decoration:none; color:white;">Logout</a>
    </form>
  </div>
</nav>
<!-- Navigation bar end  -->
...
*/ -->
      <div class="form-group col-md-4">
        ...
        <select name="grade" class="form-control">
          ...
          <option value="1st">ND1 FT</option>
          <option value="2nd">NDII FT</option>
          <option value="3rd">ND1 DPT</option>
          <option value="4th">ND11 DPT</option>
          <option value="5th">HND1 FT</option>
          <option value="6th">HNDII FT</option>
          <option value="7th">HND1 DPT</option>
          <option value="7th">HND11 DPT</option>
        </select>
      </div>
